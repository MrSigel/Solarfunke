        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px; max-width:600px; background-color:${PAPER}; border-radius:16px; overflow:hidden; font-family:Arial, Helvetica, sans-serif;">
          ...
          <tr>
            <td style="background-color:${GREEN}; padding:28px 32px;">
              <img src="${LOGO_URL}" alt="Solarfunke" width="180" style="display:block; height:auto; border:0; outline:none; text-decoration:none;">
            </td>
          </tr>
          <!-- Gelbe Akzentlinie -->
          <tr><td style="height:4px; background-color:${YELLOW}; font-size:0; line-height:0;">&nbsp;</td></tr>
